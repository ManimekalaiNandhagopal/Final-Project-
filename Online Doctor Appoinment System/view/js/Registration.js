...
function validateForm() {
    ...
    var sel = document.Form.sel.value;



    var firnameErr = lasnameErr = moblieErr = emailErr = genderErr = selErr = true;
    ...
    if (sel == "Select") {
        printError("selErr", "Please select Patient or Doctor");
    ...
    if ((firnameErr || lasnameErr || moblieErr || emailErr || genderErr || selErr) == true) {
        return false;
    }
};